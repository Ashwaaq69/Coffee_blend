...
<section class="ftco-section">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="menu-entry">
                    <a target="_blank" href="products/product-single.php?id=<?php echo $prodcut->id; ?>" class="img"
                        style="background-image: url(<?php echo IMAGEPRODUCTS; ?>/<?php echo $prodcut->image; ?>);"></a>
                    <div class="text text-center pt-4">
                        ...
                        <p><a target="_blank" href="products/product-single.php?id=<?php echo $prodcut->id; ?>"
...
<section class="ftco-section img" id="ftco-testimony" style="background-image: url(images/bg_1.jpg);"
    ...
    <div class="container-wrap">
        ...
        <div class="row d-flex no-gutters">
            ...
            <div class="col-md-3 align-self-sm-end ftco-animate" style="margin:4px 5px;">
                <div class="testimony" style="padding: 20px; border-radius:20px;">
                    <blockquote>
